package com.example.hellohamsterdemo.domain.image.service;
...
import com.example.hellohamsterdemo.domain.image.ErrorCode;
import com.example.hellohamsterdemo.domain.image.S3Exception;
import com.example.hellohamsterdemo.domain.image.dto.ImageCreateDTO;
...
public class S3ImageService {
    ...
    public Image save(ImageCreateDTO dto) {
    ...
    public List<String> uploadTaskImages(List<MultipartFile> images, Long memberId, Long taskId) {
        ...
        for (MultipartFile image : images) {
            ...
            ImageCreateDTO imageTaskDTO = new ImageCreateDTO(memberId, url, "task", taskId, null, null);
            save(imageTaskDTO);
